...
const sendMkeka3 = async (ctx, delay, bot, imp) => {
    ...
    try {
        ...
        if (keka.length > 0) {
            ...
            let ug = `https://mkekawaleo.com/1xbet/register`
            let t22 = `https://mkekawaleo.com/22bet-tz/register`
            let prm = `https://mkekawaleo.com/premierbet/register`

            let finaText = txt + `<b>🔥 Total Odds: ${odds}</b>\n\n▬▬▬▬▬▬▬▬▬▬▬▬\n\nThese bet options are available at <b>1xbet</b> with a 200% bonus on your 1st deposit\n\n<b>✓ Register Now \n\n👤 (Kenya 🇰🇪)\n<a href="${ke}">https://1xbet.co.ke/register\nhttps://1xbet.co.ke/register</a>\n\n👤 (Uganda 🇺🇬)\n<a href="${ug}">https://1xbet.ug/register</a>\n\n👤 (Tanzania 🇹🇿)\n<a href="${gsb}">https://1xbet.co.tz/register</a>\n\n\n\n#WinWithEditha</b>`
